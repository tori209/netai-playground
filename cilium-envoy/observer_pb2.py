...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETFLOWSREQUEST_EXPERIMENTAL'].fields_by_name['field_mask']._loaded_options = None
  _globals['_GETFLOWSREQUEST_EXPERIMENTAL'].fields_by_name['field_mask']._serialized_options = b'\030\001'
